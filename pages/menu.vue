<template>
  ...
  export default {
    data() {
      return {
        menuItems: [
          { image: 'https://via.placeholder.com/300', text: 'Item 1', link: '/page1' },
          { image: 'https://via.placeholder.com/300', text: 'Item 2', link: '/page2' },
          { image: 'https://via.placeholder.com/300', text: 'Item 3', link: '/page3' },
